...
import { useDashboardData } from '../../api/mfc';
      ...
      {data && !isError && (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <AvailabilityCard label="UltraFresh Availability" data={data.ultrafreshAvailabilityCard?.[period]} />
          ...
          <section className="bg-surface-container-lowest border border-outline-variant rounded-lg p-3.5 shadow-card">
            ...
            <p className="text-[11px] text-secondary mt-0.5 mb-3">
              Ultrafresh vs. LOSF1 vs. MNLF1 Availability
            </p>
                ...
                {rows.length === 0 ? (
                  ...
                  <ResponsiveContainer width="100%" height={Math.max(200, rows.length * 44)}>
                    ...
                    >
                      ...
                      <Bar dataKey="quantityOrdered" name="Ordered" fill="#00A082" maxBarSize={13} radius={[0, 3, 3, 0]}>
